...
public class OpenPGPDecryption {
    ...
    private static final Logger log = LogManager.getLogger(OpenPGPDecryption.class);

    public static void main(String[] args) {
        try {
//            PropertyConfigurator.configure("config/corpapp.log.properties");
//			if(args == null || args.length < 4) {
//				System.out.println("Usage: java -cp \"lib/*\" vn.tcb.crypto.TcbDecryption [Root-Folder] [Parnter-Private-Key-Path] [Partner-Passphrase] [TCB-Public-Key-Path]");
//				return;
//			}

            // Root folder (direct parent folder of reconcile folder)
//			final String rootFolder = args[0];
            final String rootFolder = "D:\\testTCB";

            // Partner keys paths
//			final String partnerKeyPath = args[1];
//			final String partnerPassphrase = args[2];
            //final String partnerKeyPath = "D:\\Programs\\Source\\01.CorpApps\\01.Reconcile\\ReconcileDeploy\\partners\\PAYOO\\Partner_Private.gpg";
            final String partnerKeyPath = "D:\\testTCB\\pgp_key-sec.asc";
            final String partnerPassphrase = "KDf=4$;&&x5g";

            // TCB public key path
//			final String tcbPublicKeyPath = args[3];
            //final String tcbPublicKeyPath = "D:\\Programs\\Source\\01.CorpApps\\01.Reconcile\\ReconcileDeploy\\keys\\TcbTestPublicKey.asc";
//            final String tcbPublicKeyPath = "D:/Document/VSVC/public-certificate.pem";
...
//			}
     ...
     * @throws Exception
     */
    public static boolean partnerDecryptReconfiles(String encryptFolder, String decryptFolder, String partnerKeyPath, String partnerPassphrase) throws Exception {
//        PropertyConfigurator.configure("config/corpapp.log.properties");
        // Load Partner key
        ...
        for (File encryptedFile : encryptedFiles) {
            ...
            final File decryptFile = new File(decryptFolder + "/" + encryptedFile.getName().replace(".pgp", ""));
     ...
     * @throws Exception
     */
    public static boolean partnerVerifyReconfiles(String decryptFolder, String verifyFolder, String tcbPublicKeyPath) throws Exception {
     ...
     */
    static boolean decryptFile(InputStream dataIn, InputStream keyIn, char[] passwd, File decryptFile)
...
//			Iterator<PGPPublicKeyEncryptedData> it = enc.getEncryptedDataObjects();
     ...
     */
    static boolean verifyFile(InputStream dataIn, InputStream keyIn, File originalFile) throws Exception {
     ...
     */
//    public static void configLog4j(String rootFolder, String curdate) {
