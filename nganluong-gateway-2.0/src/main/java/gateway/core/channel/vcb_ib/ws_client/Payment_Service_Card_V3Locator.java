...
public class Payment_Service_Card_V3Locator extends org.apache.axis.client.Service implements Payment_Service_Card_V3 {

    // Use to get a proxy class for Payment_Service_Card_V3Soap
    private String Payment_Service_Card_V3Soap_address = VCBIbConstants.URL_API_CALL_VCB;
    ...
    public Payment_Service_Card_V3Soap getPayment_Service_Card_V3Soap() throws javax.xml.rpc.ServiceException {
    ...
    public Payment_Service_Card_V3Soap getPayment_Service_Card_V3Soap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Payment_Service_Card_V3SoapStub _stub = new Payment_Service_Card_V3SoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Payment_Service_Card_V3Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                Payment_Service_Card_V3SoapStub _stub = new Payment_Service_Card_V3SoapStub(new java.net.URL(Payment_Service_Card_V3Soap_address), this);
                _stub.setPortName(getPayment_Service_Card_V3SoapWSDDServiceName());
                return _stub;
            }
        } catch (Throwable t) {
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.vietcombank.com.vn/Services/VPGServicesV4/", "Payment_Service_Card_V3");
    }

    public java.util.Iterator getPorts() {
        if (ports == null) {
            ports = new java.util.HashSet();
            ports.add(new javax.xml.namespace.QName("http://www.vietcombank.com.vn/Services/VPGServicesV4/", "Payment_Service_Card_V3Soap"));
        }
