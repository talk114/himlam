...
@WebServiceClient(name = "NCC_WSDL", targetNamespace = "BIDVWS", wsdlLocation = "classpath:bidv/BIDVPaygateWS.wsdl")

public class NCCWSDL extends Service {
    ...
    static {
        ...
        try {
            url = new ClassPathResource("bidv/BIDVPaygateWS.wsdl").getURL();
